...
public class EmailPresupuesto extends Thread {
	...
	private void enviarPresupuesto() {
		...
		for (int i = 0; i < ventana.getComponentes_table().getRowCount(); i++) {
			...
			componentes += "<b>Repuesto:</b>&nbsp;&nbsp;"
					+ (String) ventana.getComponentes_table().getModel().getValueAt(i, 1) + "&nbsp; &nbsp;&nbsp;&nbsp;"
					+ "<b>Cantidad:</b>&nbsp;&nbsp;" + (int) ventana.getComponentes_table().getModel().getValueAt(i, 2)
					+ "&nbsp;&nbsp;&nbsp;&nbsp;" + "<b>PrecioTotal: $ </b>&nbsp;&nbsp;"
					+ (float) ventana.getComponentes_table().getModel().getValueAt(i, 4) + "<br>";
		}
		...
		String mensaje =
				...
				"<p>Estimado cliente:  " + ingreso.getCliente().getNombre() + " " + ingreso.getCliente().getApellido()
						+ " </p><br>" + "<p style=text-indent:4cm > El presupuesto por la reparaci&#243;n Nro: <b> "
						+ ingreso.getId() + " </b> del producto <b>" + ingreso.ingr.getDescripcion() + "</b> "
						+ "ingresado el d&#237;a  " + ingreso.getIngreso().getFecha_creacion()
						+ " consta del siguiente detalle: </p><br> " + "<p> <b> Informe t&#233;cnico:     </b>"
						+ ventana.getDescripcionBreve_jTextArea().getText() + "</p><br>"
						+ "<p> <b>Repuestos a utilizar:  </b></p><br>" + "<p>" + componentes + " </p> <br>"
						+ "<p> <b>Total de repuestos:     $  </b>" + ventana.getTotal_lbl().getText() + "</p><br>"
						+ "<p> <b>Mano de Obra:     $  </b>" + ventana.getManoDeObra_txf().getText() + "</p><br>"
						+ "<p> <b>Total presupuesto:     $  </b>" + ventana.getValorPresupuestado_txf().getText()
						+ "</p><br>" + "<p> <b>Env&#237;o a domicilio:    $  </b> " + envio + "</p><br>"
						+ "<p> <b>Total :     $  </b> " + totalpresupuesto + "</p><br>"
						+ "<p> <b>Le solicitamos que confirme el presupuesto antes de " + fechaVencimiento
						+ ".</b></p><br>" + "<p> <b>ATTE:  </b>" + usuario.getNombre() + "   " + usuario.getApellido()
						+ "</p>";
