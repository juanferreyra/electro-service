...
public class ReparacionesDAO {
	...
	private static final String insert = "INSERT INTO reparaciones ("
	...
	public boolean insert(ReparacionDTO componente) {
		...
		try {
			...
			statement.setString(1, componente.getTecnico_asignado());
			statement.setDate(2, (Date) componente.getFecha_reparacion());
			statement.setInt(3, componente.getHoras());
