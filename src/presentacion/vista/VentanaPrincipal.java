...
public class VentanaPrincipal extends JFrame {
	...
	public VentanaPrincipal() {
		...
		_gestion = new JMenu("Gesti�n de Datos");
		...
		DefaultTableModel modeloOrdenesTrabajo = new DefaultTableModel(new Object[][] {}, new String[] { "", "N�mero",
				"Fecha", "Producto", "Cliente", "Env�o", "", "T�cnico Asignado", "Estado" }) {
	...
	private void cargarItemsDeSistema() {
		deslogueo = new JMenuItem("Cerrar Sesi�n");
