...
public class ControladorVentanaIngreso implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.ventana_ingreso.getBtnBuscarCliente()) {
			...
			if (descripcion_falla.equals("") && !error) {
				error = true;
				JOptionPane.showMessageDialog(this.ventana_ingreso,
						"La descripcion de la falla est� vacia. Por favor, vuelva a intentarlo.", null,
						JOptionPane.INFORMATION_MESSAGE);
			}
			...
			if (this.ventana_ingreso.getEnvioDomicilio().isSelected() && !error) {
				...
				if (monto.equals("") && !error) {
					...
					try {
						...
						error = true;
						JOptionPane.showMessageDialog(this.ventana_ingreso,
								"El monto no es v�lido. Por favor, vuelva a intentarlo.", null,
								JOptionPane.INFORMATION_MESSAGE);
					}
				}
			}
	...
	private void buscarCliente() {
		...
		if (textoingresado == null || textoingresado.equals("")) {
			JOptionPane.showMessageDialog(this.ventana_ingreso, "Por favor, ingrese un n�mero de cliente.", null,
					JOptionPane.INFORMATION_MESSAGE);
		} else {
			try {
				...
				if (cdto == null) {
					JOptionPane.showMessageDialog(this.ventana_ingreso,
							"El cliente buscado no existe, por favor, ingrese un valor v�lido.", null,
							JOptionPane.INFORMATION_MESSAGE);
				} else {
				...
				JOptionPane.showMessageDialog(this.ventana_ingreso,
						"El n�mero de cliente es incorrecto, vuelva a intentarlo. ", null,
						JOptionPane.INFORMATION_MESSAGE);
			}
		}
